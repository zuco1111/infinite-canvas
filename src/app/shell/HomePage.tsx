...
import { fetchPrompts, type Prompt } from '@/features/prompts';
import { navigationTools } from '@/app/shell/navigation-tools';
  ...
  return (
    <span className="relative inline-block px-1">
      {action === 'highlight' ? (
        ...
        <span
          className="absolute inset-x-0 bottom-0 h-1 rounded-full opacity-80"
          style={{ backgroundColor: color }}
        />
      )}
