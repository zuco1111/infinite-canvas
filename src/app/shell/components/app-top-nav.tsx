...
import { navigationTools, type NavigationToolSlug } from '@/app/shell/navigation-tools';
import { AppConfigModal, UserStatusActions } from '@/features/settings';
import { MobileNavDrawer } from '@/app/shell/components/mobile-nav-drawer';
