    ...
    const move = (event: PointerEvent) => {
      ...
      setCrop(
        mode === 'move'
          ...
          : resizeCrop(start.crop, dx, dy, handle || 'se', locked, box),
      );
    };
    const up = () => {
    ...
    >
      <div className="space-y-4">
        <div className="flex justify-center">
          <div
            ref={boxRef}
            className="relative inline-block max-w-full overflow-hidden rounded-lg bg-black select-none"
          >
            <img
              src={dataUrl}
              alt=""
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border px-3 py-2">
          ...
          <Button
            icon={locked ? <Lock className="size-4" /> : <LockOpen className="size-4" />}
