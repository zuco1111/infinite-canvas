...
import { AudioSettingsPanel } from '@/features/generation';
import { audioFormatLabel, audioSpeedLabel, audioVoiceLabel } from '@/features/generation';
      ...
      <span ref={buttonRef} className="inline-flex min-w-0">
        ...
        >
          <span className="truncate">
            {audioVoiceLabel(config.audioVoice)} · {audioFormatLabel(config.audioFormat)} ·{' '}
