...
import {
  ...
  type CanvasTheme,
} from '@/shared/tokens/canvas-theme';
import { useAppTheme, useSetAppTheme } from '@/features/settings';
    ...
    <Button
      ...
      style={
        active
          ...
          : hovered === id && !disabled
            ? hoverStyle
            : { color: danger ? '#f87171' : theme.toolbar.item, opacity: disabled ? 0.35 : 1 }
      }
      icon={children}
      onMouseEnter={(event) => {
        onHover(id);
