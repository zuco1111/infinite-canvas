...
- 2026-07-09 将版本号更新为 `0.3.0`，并同步 `package.json` 与 `package-lock.json`。
...
- 2026-07-09 调整设置弹窗 API 渠道提示文案，将控制台入口更新为指向 `https://api.zuco.ai/` 的“立即购买”入口，并在产品约束中记录该例外。
...
- 2026-07-09 版本 `0.3.0` 追加验证：`npm run check` 通过，13 个测试文件、36 个测试全部通过。
